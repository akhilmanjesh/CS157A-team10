    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col">
        <div class="card card-registration my-4">
          <div class="row g-0 align-items-center" style="background-color:#002244">
            <div class="col-xl-7 d-none d-xl-block align-"  mx-auto>
              <div class="text-center">
                <img src="./spartan_logo.png" class="img-fluid" alt="Responsive image" style="width:300px">
              </div>
            </div>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-md-2">
                        <div class="alert alert-danger" role="alert">
                          <div class ="text-center">Username already taken!</div>
                        </div>
                      </div>
                    </div>
                  </div>
